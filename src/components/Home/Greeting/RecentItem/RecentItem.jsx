...
const RecentItem = (props) => {
  return (
    <>
      <div style={{backgroundImage: `url(${Circle}`}} className="p-3 min-w-[166px] bg-[#787CF8] rounded-md mr-2 sm:mr-4 sm:pt-4 flex flex-col justify-between bg-blend-overlay bg-no-repeat bg-right-bottom">
