...
const Preloader = (props) => {
  ...
  return (
    <>
      <div
        className={`fixed left-0 top-0 z-[10000000000000] ${showPreloader ? "flex" : "hidden"} h-[100dvh] w-[100%] flex-col items-center justify-center overflow-hidden transition-all duration-500`}
        style={{
